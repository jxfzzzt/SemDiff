...
public class Permutations<E> implements java.util.Iterator<List<E>> {
	...
	/**
	 * Create a Permutation to iterate through all possible lineups of the
	 ...
	 *         Iterator, which declares that the next() returns a plain Object.
